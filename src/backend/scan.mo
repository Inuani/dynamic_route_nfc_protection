...
module {
    ...
    //     for (i in Iter.range(0, sha.size() - 1)) {
    //     let calculated = Nat8.toNat(sha[i]);
    //     let stored = hexToNat(subText(cmacs[counter - 1], i * 2, i * 2 + 2));
        
    //     Debug.print("Byte " # Nat.toText(i) # ":");
    //     Debug.print("  Calculated: " # Nat.toText(calculated));
    //     Debug.print("  Stored: " # Nat.toText(stored));
        
    //     if (calculated != stored) {
    //         Debug.print("Mismatch at byte " # Nat.toText(i));
    //         res := 0;
    //     };
    // };

    // Debug.print("Final result: " # Nat.toText(res));
